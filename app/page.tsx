...
export default async function HomePage() {
  ...
  return <TacticalShell showLoader>
    ...
    <section id="honorary" className="section-pad dark-section reveal"><SectionKicker number="06" label="HONORARY ROLL" /><div className="section-heading"><h2>REMEMBERED<br /><em>BY THE UNIT.</em></h2><a className="text-link" href="/honorary">HALL OF FAME <span>↗</span></a></div><div className="honorary-preview"><article><div className="honorary-mark">∞</div><div><span>001 // HONORARY</span><h3>THE FOUNDING CADRE</h3><p>For those who shaped the standard before there was a name for it.</p></div></article><article><div className="honorary-mark">∞</div><div><span>002 // HONORARY</span><h3>THE QUIET PROFESSIONALS</h3><p>For operators whose work made the next mission possible.</p></div></article></div></section>
