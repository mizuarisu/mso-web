...
export default async function HomePage() {
  ...
  return <TacticalShell showLoader>
    ...
    <section className="red-band"><div><span>MSO // ACCESS</span><h2>READY WHEN<br />IT <em>MATTERS.</em></h2></div><Link className="button button-light" href="/access">REQUEST ACCESS <span>↗</span></Link></section>
  </TacticalShell>
}
