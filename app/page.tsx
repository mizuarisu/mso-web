...
export default async function HomePage() {
  ...
  return <TacticalShell showLoader>
    ...
    <section id="command" className="section-pad command-home dark-section reveal"><SectionKicker number="04" label="CHAIN OF COMMAND" /><div className="section-heading"><h2>THE FEW WHO <em>LEAD.</em></h2><a className="text-link" href="#command">VIEW COMMAND <span>↗</span></a></div><div className="command-branch"><div className="command-node command-root"><span>01</span><b>COMMANDING OFFICER</b><strong>COL. A. MERCER</strong></div><div className="command-branches"><div className="command-node"><span>02</span><b>EXECUTIVE OFFICER</b><strong>MAJ. R. VALE</strong></div><div className="command-node"><span>03</span><b>OPERATIONS LEAD</b><strong>CAPT. J. ORTIZ</strong></div><div className="command-node"><span>04</span><b>INTELLIGENCE DIRECTOR</b><strong>LT. S. KOVAČ</strong></div></div></div></section>
    ...
    <section id="honorary" className="section-pad dark-section reveal"><SectionKicker number="06" label="HONORARY ROLL" /><div className="section-heading"><h2>REMEMBERED<br /><em>BY THE UNIT.</em></h2><a className="text-link" href="#honorary">HALL OF FAME <span>↗</span></a></div><div className="honorary-preview"><article><div className="honorary-image" style={{ backgroundImage: "url('/images/tactical-close.png')" }} /><div><span>001 // HONORARY</span><h3>THE FOUNDING CADRE</h3><p>For those who shaped the standard before there was a name for it.</p></div></article><article><div className="honorary-image" style={{ backgroundImage: "url('/images/tactical-night.png')" }} /><div><span>002 // HONORARY</span><h3>THE QUIET PROFESSIONALS</h3><p>For operators whose work made the next mission possible.</p></div></article></div></section>
