...
export default async function HomePage() {
  ...
  return <TacticalShell showLoader>
    ...
    <section id="command" className="section-pad command-home dark-section reveal"><SectionKicker number="04" label="CHAIN OF COMMAND" /><div className="section-heading"><h2>THE FEW WHO <em>LEAD.</em></h2><a className="text-link" href="#command">VIEW COMMAND <span>↗</span></a></div><div className="command-branch"><div className="command-node command-root"><img src="/images/tactical-close.png" alt="Commander profile" /><span>01</span><div><b>COMMANDER · FIRST IN COMMAND</b><strong>CMSO. WAIEFV</strong></div></div><div className="command-branches command-chain"><div className="command-node"><img src="/images/tactical-night.png" alt="Lieutenant Commander profile" /><span>02</span><div><b>LIEUTENANT COMMANDER · SECOND IN COMMAND</b><strong>LTCMDR. BRAVO0665</strong></div></div><div className="command-node"><img src="/images/tactical-ocean.png" alt="Defense Intelligence Advisor profile" /><span>03</span><div><b>DEFENSE INTELLIGENCE ADVISOR · THIRD IN COMMAND</b><strong>N/A</strong></div></div><div className="command-branches command-final"><div className="command-node"><img src="/images/tactical-desert.png" alt="Squadron Commander cell one" /><span>04A</span><div><b>SQUADRON COMMANDER</b><strong>SC. TYIRGHU2</strong></div></div><div className="command-node"><img src="/images/tactical-desert.png" alt="Squadron Commander cell two" /><span>04B</span><div><b>SQUADRON COMMANDER</b><strong>SC. SILENTSOLDIER621</strong></div></div><div className="command-node"><img src="/images/tactical-training.png" alt="Strategic Vanguard cell one" /><span>05A</span><div><b>STRATEGIC VANGUARD</b><strong>SV. XYVZVZ</strong></div></div><div className="command-node"><img src="/images/tactical-training.png" alt="Strategic Vanguard cell two" /><span>05B</span><div><b>STRATEGIC VANGUARD</b><strong>SV. NOOBY_RL</strong></div></div></div></div></div></section>
    ...
    <section id="honorary" className="section-pad dark-section reveal"><SectionKicker number="06" label="HONORARY ROLL" /><div className="section-heading"><h2>REMEMBERED<br /><em>BY THE UNIT.</em></h2><a className="text-link" href="#honorary">HALL OF FAME <span>↗</span></a></div><div className="honorary-preview"><article><div className="honorary-image" style={{ backgroundImage: "url('/images/tactical-close.png')" }} /><div><span>001 // HONORARY</span><h3>BLUEYHAVOC</h3><p>For those who shaped the standard before there was a name for it.</p><a className="text-link" href="https://www.roblox.com/communities/156700841" target="_blank" rel="noreferrer">VISIT PROFILE <span>↗</span></a></div></article><article><div className="honorary-image" style={{ backgroundImage: "url('/images/tactical-night.png')" }} /><div><span>002 // HONORARY</span><h3>MIKKY4K</h3><p>For operators whose work made the next mission possible.</p><a className="text-link" href="https://www.roblox.com/communities/156700841" target="_blank" rel="noreferrer">VISIT PROFILE <span>↗</span></a></div></article><article className="honorary-placeholder"><div className="honorary-image" style={{ backgroundImage: "url('/images/visual-log-archive.png')" }} /><div><span>003 // HONORARY</span><h3>6ENNSORDD</h3><p>A place reserved for the next operator whose service shapes the unit.</p><a className="text-link" href="#honorary">VISIT PROFILE <span>↗</span></a></div></article><article className="honorary-placeholder"><div className="honorary-image" style={{ backgroundImage: "url('/images/signals-archive.png')" }} /><div><span>004 // HONORARY</span><h3>LATTEARTS</h3><p>A place reserved for the next operator whose standard carries forward.</p><a className="text-link" href="#honorary">VISIT PROFILE <span>↗</span></a></div></article><article className="honorary-placeholder"><div className="honorary-image" style={{ backgroundImage: "url('/images/gallery-briefing.png')" }} /><div><span>005 // RESERVED</span><h3>N/A</h3><p>This could be you in the future!</p><a className="text-link" href="#honorary">VISIT PROFILE <span>↗</span></a></div></article></div></section>
